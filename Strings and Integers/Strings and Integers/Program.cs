...
namespace Strings_and_Integers
{
    internal class Program
    {
        ...
        {
            //Create a list of interegers
            List<int> intList = new List<int>() { 5, 10, 23, 29, 189, 24, 14, 2934, 129, 86030 };
            ...
            Console.WriteLine("The program has existed the try/catch block.");
        }
    }
}
